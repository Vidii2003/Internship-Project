    ...
    <div className='form-container per'>
      <div className='form-box'>
        ...
        <div className='form-group'>
          ...
          <div className="input-box">
            <label className="dobh2">Date of Birth:<span className="required">*</span></label>
            <input
              type="date"
              className="date-picker"
              value={`${year ? year : ""}-${month ? String(month).padStart(2, "0") : ""}-${day ? String(day).padStart(2, "0") : ""}`}
              onChange={(e) => {
                const [selectedYear, selectedMonth, selectedDay] = e.target.value.split("-");
